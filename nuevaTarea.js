var nuevaTarea = {
	...
	insertarNuevaTarea: {
		...
		getDatosTarea: function(){
			...
			tarea.id_historia = nuevaTarea.id; document.getElementById("id_historia").getContext;
		...
		validacionTarea: function(tarea){
			...
			if (errores === ""){
				...
				logicaTarea.callbackNuevaTarea({nombre: tarea.nombre, descripcion: tarea.descripcion, pruebas: tarea.pruebas, coste: tarea.coste, prioridad: tarea.prioridad, id_historia: tarea.id_historia, a2: 'añadir'}, nuevaTarea.creacionDivTarea.tareaCreate);		
			} else {
